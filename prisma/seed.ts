...
const NOTIFICATION_TEMPLATES: { key: string; name: string; type: string; subject: string; body: string; variables: string[] }[] = [
  ...
  },
  {
    ...
    body: "Dear {{requesterName}},<br/><br/>An approver requested a correction for <strong>{{itemLabel}}</strong> on request <strong>{{requestNumber}}</strong>.<br/>Comments: {{comments}}<br/>{{actionButton}}",
    variables: ["requesterName", "itemLabel", "requestNumber", "comments", "actionButton"],
  },
  {
    ...
    body: "Dear {{employeeName}},<br/><br/>Your access to <strong>{{applicationName}}</strong> has been set up. For security your credentials are not included in this email.<br/>{{actionButton}}",
    variables: ["employeeName", "applicationName", "actionButton"],
  },
  {
    key: "asset_handover",
    name: "Asset Handover",
  ...
  },
  {
    ...
    body: "Dear {{recipientName}},<br/><br/><strong>{{itemLabel}}</strong> on request <strong>{{requestNumber}}</strong> has completed approval and is ready for IT to implement.<br/>Requested for: {{requestedForName}}<br/>{{actionButton}}",
    variables: ["recipientName", "itemLabel", "requestNumber", "requestedForName", "actionButton"],
  },
  {
  ...
  },
  {
    ...
    body: "This is a reminder that an action assigned to you on request <strong>{{requestNumber}}</strong> is still pending.<br/>{{actionButton}}",
    variables: ["requestNumber", "actionButton"],
  },
  {
    key: "system_alert",
    name: "System Alert",
