  ...
  return (
    <div className={className ?? "relative w-full sm:w-72"}>
      ...
      <input
        ...
        className="h-9 w-full rounded-full border border-input bg-card pl-9 pr-4 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
      />
    </div>
  );
}
