...
/**
 * Public request portal index: lists every published form grouped by company
 * and request type so requesters choose what to request, then enter details.
 */
  ...
  return (
    <main className="min-h-screen bg-background py-10">
      <div className="mx-auto w-full max-w-2xl px-4">
        ...
        <p className="mt-8 text-center text-xs text-muted-foreground">Powered by Axivo</p>
      </div>
    </main>
  );
}
